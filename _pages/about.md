...
Together with Andrey Shcherbak from HSE St Petersburg we conduct the first audit study of ethnic discrimination in the Russian labour market. We have sent over 9,000 job applications in four Russian cities to explore the differences in response rates across 10 ethnic groups. The data collection finished in January 2018 and we are currently analysing the data and writing up the results. Please see the presentation with the preliminary results (January 2018) here. The project has been supported by the British Academy and the HSE.
...
In Exeter, I teach courses on immigration, policy evaluation in education and advanced data analysis. Please see the details in Teaching,
