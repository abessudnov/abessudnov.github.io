---
title: "Alexey Bessudnov"
about:
  template: trestles
  image: images/avatar_cropped.jpeg
  image-shape: rectangle
  links:
    - icon: envelope
      text: Email
      href: mailto:a.bessudnov@exeter.ac.uk
    - icon: mortarboard-fill
      text: Google Scholar
      href: https://scholar.google.co.uk/citations?user=62MAt6gAAAAJ&hl=en
    - icon: github
      text: GitHub
      href: https://github.com/abessudnov
    - icon: twitter
      text: Twitter
      href: https://twitter.com/abessudnv
---
...
In Exeter, I teach social analysis, immigration and statistical data analysis. Please see details in [Teaching](teaching.qmd).
